            ...
            <div class="card-body">
              <div class="row">
                <div class="col-6 d-flex justify-content-center">
                  <a style="text-decoration: none;" href="abrir_chamado.php?voltar=admin.php"><img src="../img/formulario_abrir_chamado.png" width="70" height="70"><b style="color: black;">Abrir Chamado</b></a>
                </div>
                <div class="col-6 d-flex justify-content-center">
                  <a style="text-decoration: none;" href="consultar_chamado.php?voltar=admin.php"><img src="../img/formulario_consultar_chamado.png" width="70" height="70"><b style="color: black;">Consultar Chamado</b></a>
                </div>
              </div>
            </div>
          </div>
